      ...
      <main className="flex justify-between py-2 px-6">
        <section className="flex justify-between items-start space-y-2">
          <div className=" text-white font-serif px-6 py-10 text-justify text-opacity-100">
            ...
            <p className="text-2xl py-10 md:text-2xl">Welcome to The Wall Art! We are passionate about bringing creativity and inspiration into your spaces through our curated collection of wall decor ideas. Here, you all find a delightful variety of aesthetic and artistic pieces, including stunning 3D designs that truly transform any room into a masterpiece.
              ...
              Join us on this journey to discover art that not only beautifies your walls but also tells your story. We are dedicated to helping you find that perfect piece that makes your space feel warm and inviting—because every wall has a tale to tell!  <Link href="/gallery">
